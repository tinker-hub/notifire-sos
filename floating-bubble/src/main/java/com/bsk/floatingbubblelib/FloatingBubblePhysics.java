...
public class FloatingBubblePhysics extends DefaultFloatingBubbleTouchListener {
  ...
  private FloatingBubblePhysics(Builder builder) {
    sizeX = builder.sizeX;
    int sizeY = builder.sizeY;
    bubbleView = builder.bubbleView;
    WindowManager windowManager = builder.windowManager;
    FloatingBubbleConfig config = builder.config;
  ...
  public void onUp(float x, float y) {
    addSelectively(x, y);
    Log.d(FloatingBubblePhysics.class.getSimpleName(), Arrays.toString(previous));
